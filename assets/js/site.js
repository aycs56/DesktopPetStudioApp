(function () {
  ...
  const labels = {
    "zh-Hant": { product: "產品介紹", workshop: "自訂與工作坊", privacy: "隱私權政策", terms: "使用條款", support: "支援資訊", language: "語言", menu: "開啟導覽選單", closeMenu: "關閉導覽選單", skip: "跳至主要內容", copyright: "DesktopPetStudio. 保留所有權利。", launch: "發布前設定" },
    "zh-Hans": { product: "产品介绍", workshop: "自定义与创意工坊", privacy: "隐私政策", terms: "使用条款", support: "支持信息", language: "语言", menu: "打开导航菜单", closeMenu: "关闭导航菜单", skip: "跳至主要内容", copyright: "DesktopPetStudio. 保留所有权利。", launch: "发布前设置" },
    en: { product: "Product", workshop: "Customize & Workshop", privacy: "Privacy", terms: "Terms", support: "Support", language: "Language", menu: "Open navigation menu", closeMenu: "Close navigation menu", skip: "Skip to main content", copyright: "DesktopPetStudio. All rights reserved.", launch: "Pre-launch settings" }
  };
  ...
  const creatorTopicCatalogs = {
    "zh-Hant": {
      ...
      topics: [
        ...
        { id: "ai", title: "AI 素材提示與多語系", description: "提供多語系 Prompt，清楚要求六張獨立透明背景影格。", code: "\"ai_asset_prompts\": [{\n  \"id\": \"wave_prompt\",\n  \"pose_id\": \"wave\",\n  \"zh\": \"輸出六張獨立透明 PNG，不要六宮格。\",\n  \"en\": \"Output six separate transparent PNG frames; no grid.\"\n}]" },
    ...
    "zh-Hans": {
      ...
      topics: [
        ...
        { id: "ai", title: "AI 素材提示与多语言", description: "提供多语言 Prompt，明确要求六张独立透明背景帧。", code: "\"ai_asset_prompts\": [{\n  \"id\": \"wave_prompt\",\n  \"pose_id\": \"wave\",\n  \"zh\": \"输出六张独立透明 PNG，不要六宫格。\",\n  \"en\": \"Output six separate transparent PNG frames; no grid.\"\n}]" },
    ...
    en: {
      ...
      topics: [
        ...
        { id: "ai", title: "AI asset prompts and languages", description: "Give players multilingual prompts that ask for six separate transparent frames.", code: "\"ai_asset_prompts\": [{\n  \"id\": \"wave_prompt\",\n  \"pose_id\": \"wave\",\n  \"zh\": \"輸出六張獨立透明 PNG，不要六宮格。\",\n  \"en\": \"Output six separate transparent PNG frames; no grid.\"\n}]" },
  ...
  function setupMotion() {
    ...
    const targets = Array.from(document.querySelectorAll(
      ".hero-content, .feature-card, .step, .image-stage, .creator-path, .creator-care-highlight, .creator-pet-rail, .creator-guide-intro, .creator-overview-heading, .creator-pack-grid, .creator-pack-card, .creator-capability-card, .creator-overview-cta, .creator-topic-examples, .support-banner, .faq-list"
    ));
